    ...
    render(){
        ...
        return (
            <TouchableOpacity  {...this.props}>
                <View style={[styles.center,styles.w_100,{borderRadius:5,paddingHorizontal:10,minWidth:120,  height:45,backgroundColor:!Boolean(mode) ? colors.accent : 'transparent',...more}]} ><Paragraph style={[styles.w_100,{textAlign:'center',color:more?.color?more?.color:'white'}]}>{children}</Paragraph></View>
            </TouchableOpacity>
            /*<Button
                 mode={'contained'}
