...
export const ordertypes:any = [{label:'All',value:'all'},{label:'Tables',value:'tableorder'},{label:'Home Delivery',value:'homedelivery'},{label:'Takeaway',value:'takeaway'}, {label:'QSR',value:'qsr'}];
...
export let localredux:any = {
  ...
  addonsData:'',
  clientsData:'',
  localSettingsData:{taxInvoice: false, currentLocation: {},lastSynctime:'', isRestaurant: false, currentTable:{}},
}
